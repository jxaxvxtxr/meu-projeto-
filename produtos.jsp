...
<!--
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link click-scroll" href="../../html/quemsomos.php">Sobre nós</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link click-scroll" href="../../html/galeria.php">Galeria</a>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarLightDropdownMenuLink">
                            <li><a class="dropdown-item" href="../../html/donuts.php">Donuts</a></li>

                            <li><a class="dropdown-item" href="../../html/brownie.php">Brownies</a></li>

                            <li><a class="dropdown-item" href="../../html/trufa.php">Trufas</a></li>
        ...
        <div class="navbar-collapse" style='margin-top:45px;'>
          <section class="card">
            <div class="card-header">
              <img src="../../images/icons/casa.png" width="60px" alt="">
            </div>

            <a href="../Form/areaAdm2.jsp">
              <section>
              <div class="card-header">
              <h3>P�gina anterior</h3>
            </div>
                <div class="card-body">
    ...
    <div class="col-md-9">
      <main class="p-4">
        ...
        <section class="card">
          ...
          <a href="../listaBrownie/donuts.jsp">
            <section>
              <div class="card-body">
                <h6>Ver lista</h6>
              </div>
