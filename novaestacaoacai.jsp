    ...
    <div class="container">
        <div class="well well-sm">
            <div class="breadcrumb__text">
                <h2>Estação de Açaí­ e Sorvete</h2>
            </div>
        ...
        <div id="products" class="">
            ...
            <div class="item  col-xs-4 col-lg-4">
                <div class="thumbnail">
                    <img class="group list-group-image" src="../img/estaçãodeaçai.jpg" width="400px" height="250px"
                        alt="" />
                    <div class="caption">
            ...
            <div class="item  col-xs-4 col-lg-4">
                <div class="thumbnail">
                    <img class="group list-group-image" src="../img/estaçãodeaçai2.jpg" width="400px" height="250px"
                        alt="" />
                    <div class="caption">
                        <h4 class="group inner list-group-item-heading">
                            Açaí­ e Sorvete</h4>
