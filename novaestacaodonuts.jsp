    ...
    <div class="container">
        ...
        <div id="products" class=" ">
            ...
            <div class="item  col-xs-4 col-lg-4">
                <div class="thumbnail">
                    <img class="group list-group-image" src="../img/estaçãodedonuts.jpg" width="400px" height="250px"
                        alt="" />
                    <div class="caption">
            ...
            <div class="item  col-xs-4 col-lg-4">
                <div class="thumbnail">
                    <img class="group list-group-image" src="../img/estaçãodedonuts2.jpg" width="400px" height="250px"
                        alt="" />
                    <div class="caption">
                        <h4 class="group inner list-group-item-heading">
                            Donuts</h4>
            ...
            <div class="item  col-xs-4 col-lg-4">
                <div class="thumbnail">
                    <img class="group list-group-image" src="../img/estaçãodedonuts3.jpg" width="400px" height="250px"
                        alt="" />
                    <div class="caption">
                        <h4 class="group inner list-group-item-heading">
                            Recheios</h4>
